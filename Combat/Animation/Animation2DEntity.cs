...
namespace XiheFramework.Combat.Animation {
    public class Animation2DEntity : CombatEntityBase {
        ...
        public void Setup(CombatEntity owner, Vector3 position, Vector3 scale, bool playFirstFrameAtStart = false) {
            if (owner == null) {
                StopAndDestroy();
            }
            ...
            transform.SetParent(owner.animationRoot, false);
        ...
        public void UnregisterEvent(int frame) {
            if (m_EventMap.ContainsKey(frame)) {
