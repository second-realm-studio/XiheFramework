...
Shader "Outline"
{
	Properties
	{
		...
		[ASEBegin]_Color("Color", Color) = (0.2830189,0.2830189,0.2830189,0)
		[ASEEnd]_Width("Width", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				#endif
				float3 vertexValue = ( v.ase_normal * ( _Width * 0.001 ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=18935
7;230;1920;789;1321;106.5;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;10;-599,304.5;Inherit;False;Property;_Width;Width;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;6;-401,80.5;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-266,352.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.001;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;9;-59,-54.5;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.2830189,0.2830189,0.2830189,0;0.2924528,0.2924528,0.2924528,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5D2EC0BC53808071A2F1DE06327C48BA6D91C6AA