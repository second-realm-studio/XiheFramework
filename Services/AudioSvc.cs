...
namespace XiheFramework.Services {
    public static class AudioSvc {
        // public static AudioSource PlayAudio(EventReference reference, AudioChannelTypes channelType, AudioClip audioClip, float volume, bool loop) {
        //     return Game.Audio.Play(reference, channelType, audioClip, volume, loop);
        // }
