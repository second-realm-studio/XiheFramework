...
Shader "Xihe/SobelOutline"
{
	Properties
	{
		...
		[ASEEnd]_EdgeColor("EdgeColor", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float smoothstepResult49 = smoothstep( 0.0 , 0.02 , sqrt( ( pow( ( ( clampDepth6 * -1.0 ) + ( clampDepth20 * -2.0 ) + ( clampDepth146 * -1.0 ) + ( clampDepth148 * 1.0 ) + ( clampDepth149 * 2.0 ) + ( clampDepth150 * 1.0 ) ) , 2.0 ) + pow( ( ( clampDepth168 * -1.0 ) + ( clampDepth173 * -2.0 ) + ( clampDepth176 * -1.0 ) + ( clampDepth177 * 1.0 ) + ( clampDepth178 * 2.0 ) + ( clampDepth179 * 1.0 ) ) , 2.0 ) ) ));
				float4 lerpResult194 = lerp( tex2D( _MainTex, uv_MainTex ) , ( smoothstepResult49 * _EdgeColor ) , smoothstepResult49);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult194.rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;765.6119;280.5683;1.234805;True;False
...
Node;AmplifyShaderEditor.LerpOp;194;1205.987,652.042;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;58;766.7266,470.7946;Inherit;False;Property;_EdgeColor;EdgeColor;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3962264,0.3195977,0.3195977,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;189;1042.919,420.4768;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;218.4929,539.7538;Inherit;False;Constant;_Max;Max;2;0;Create;True;0;0;0;False;0;False;0.02;0.0189;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;59;732.5222,687.7224;Inherit;True;Property;_MainTex;MainTex;3;1;[HideInInspector];Create;True;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;14;29.44655,455.4056;Inherit;False;Property;_Threshold;Threshold;1;0;Create;True;0;0;0;False;0;False;0.75;0.538;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-2144.72,182.3657;Inherit;False;Property;_Thickness;Thickness;0;0;Create;True;0;0;0;False;0;False;0.2;0.305;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;49;671.9813,297.5055;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;193;422.4044,379.216;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;189;0;49;0
WireConnection;189;1;58;0
...
WireConnection;193;0;14;0
WireConnection;193;1;50;0
WireConnection;1;2;194;0
ASEEND*/
//CHKSM=50098E3F4AD61DB1FACCAEAE101A1FBDD6087E12